# Test cases from ElixirLS AST helpers.
#
# This are similar to the Sourceror.get_range/2 tests.
...
defmodule ASTTest do
  ...
  defp get_range(code) do
    ...
    # Get outermost range, that's why the assertions test in this suite
